  ...
  <table>
    ...
    <tr>
      <td align="center">
        ...
        <button class="mediumTextButton" dojoType="dijit.form.Button" type="submit" id="dialogPlanningPdfSubmit" onclick="protectDblClick(this);runExportPlanningToCanvasToPDF();return false;">
