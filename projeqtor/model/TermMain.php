...
class TermMain extends SqlElement {
  ...
  public $done;
  public $_sec_Price;
  public $_tab_3_3_smallLabel = array('real', 'validated', 'planned', 'amount','amountLocal', 'date');
  public $amount;
  public $validatedAmount; 
  public $plannedAmount;
  public $amountLocal;
  public $validatedAmountLocal;
  ...
  private static $_fieldsAttributes=array("name"=>"required",
                                          ...
                                          "validatedAmountLocal"=>"readonly",
                                          "validatedDate"=>"readonly",
                                          "plannedAmount"=>"readonly",
                                          "plannedAmountLocal"=>"readonly",
      	...
      	self::$_fieldsAttributes["validatedAmount"]="";
    		self::$_fieldsAttributes["validatedDate"]="";
   			self::$_fieldsAttributes["plannedAmount"]="";
 				...
 				self::$_fieldsAttributes["validatedAmountLocal"]="";
 				self::$_fieldsAttributes["validatedDateLocal"]="";
 				self::$_fieldsAttributes["plannedAmountLocal"]="";
 				self::$_fieldsAttributes["plannedDateLocal"]="";
      }
    }
	...
	public function setCalculatedFromActivities() {
		if ($this->id) {
			...
			foreach ($depList as $dep) {
				...
				$valAmountLocal+=$obj->validatedCostLocal;
				$plaAmount+=$obj->plannedCost;
				$plaAmountLocal+=$obj->plannedCostLocal;
			...
			$this->validatedAmountLocal=$valAmountLocal;
			$this->plannedAmountLocal=$plaAmountLocal;
