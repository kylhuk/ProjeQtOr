...
//  arrayCollapsed[scope]='true';
  var callXhrPost=function(intermediate) {
    ...
    dojo.xhrPost({
      url : "../tool/saveCollapsed.php?scope=" + collapsedTrueParam + "&value=true&csrfToken="+top.csrfToken,
      handleAs : "text",
      load : function(data, args) {
        if (! intermediate) {          
          if (callBack) setTimeout(callBack, 10);
...
//  arrayCollapsed[scope]='false';
  var callXhrPost=function(intermediate) {
    ...
    dojo.xhrPost({
      url : "../tool/saveCollapsed.php?scope=" + collapsedFalseParam + "&value=false&csrfToken="+top.csrfToken,
      handleAs : "text",
      load : function(data, args) {
        if (! intermediate) {
          if (callBack) setTimeout(callBack, 10);
