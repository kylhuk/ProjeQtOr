...
function showMailOptions() {
  var callback=function() {
    ...
    if (dojo.byId('objectClassRow') && dojo.byId('objectClassRow').value && dojo.byId('objectIdRow') && dojo.byId('objectIdRow').value){
      if (dojo.byId('selectEmailTemplate')) refreshListSpecific('emailTemplate','selectEmailTemplate','objectIdClass',dojo.byId('objectIdRow').value + '_' + dojo.byId('objectClassRow').value);
