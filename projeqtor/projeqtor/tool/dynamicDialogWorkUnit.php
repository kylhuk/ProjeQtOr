         ...
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          ...
          <tr>
           ...
           <table style="width:98%">
                  ...
                  $actPl = new ActivityWorkUnit();
                        if($mode =='edit'){
                          ...
                          foreach ($lstCompVal as $idLib=>$val){
                            ...
                            if($idLib=='priceLocal')$tabCompValues[$comp->id]['priceLocal'] = $val;
              ...
              <?php if ($catalog->showGlobalCurrency() ) {?>
              <tr>
                ...
                <?php foreach ($listComplexity as $comp){ 
                  ...
                  if (Project::hasProjectCurrency($idProject)) $isReadOnly= "readOnly";
                  ?>
                <td style="width:<?php echo $tdWitdh;?>%" class="assignData">
              ...
              <?php
               ...
               if ($catalog->hasCurrency()) {?>
              <tr>
                <td style="width:10%;text-align:center;" class="assignData localLabelClass"> <?php echo i18n('priceLocal').'  ('.Project::getProjectCurrency($idProject).')';?></td>
                <?php foreach ($listComplexity as $comp){ 
                  $isReadOnly = "";
                  if($mode=='edit'){
                    $readOnly = $actPl->countSqlElementsFromCriteria(array('idComplexity'=>$comp->id,'idWorkUnit'=>$id));
                ...
                <td style="width:<?php echo $tdWitdh;?>%" class="assignData">
                <div dojoType="dijit.form.NumberTextBox" <?php echo $isReadOnly; ?> id="priceLocal<?php echo $comp->id;?>" name="priceLocal<?php echo $comp->id;?>" type="text" style="padding:0 !important;margin:0 !important; height:100% !important;width:100% !important;" class="input localFieldClass"  value="<?php if($mode=='edit'){echo $tabCompValues[$comp->id]['priceLocal'];} ?>"> 
                <?php echo $keyDownEventScript;?>
                <?php echo $catalog->getLocalToGlobalUpdateScript("priceLocal$comp->id", "price$comp->id");?>
                </div>
                </td>
                <?php } ?>
              </tr>
