...
<div >
  ...
  <div id="dialogNoteMinimizeIcon" title="<?php echo i18n('minimize'); ?>" class="minimizeIcon" tabindex="-1" onClick="minimizeNoteEditor('<?php echo i18n('dialogNote'); ?>', '<?php echo $objectId; ?>', '<?php echo $objectClass; ?>');"></div>
</div>
<div >
    ...
    <tr>
      <td align="center">
        ...
        <button class="mediumTextButton"  dojoType="dijit.form.Button" type="button" 
          onclick="dijit.byId('dialogNote').hide(); var minimizedIcon=dojo.query('[id^=noteEditorMinimizedIcon_]').shift(); if (minimizedIcon) minimizedIcon.parentNode.removeChild(minimizedIcon);">
