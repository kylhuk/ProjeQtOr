...
var tabPlanView=['Planning','GlobalPlanning','PortfolioPlanning','ResourcePlanning','VersionsPlanning','ContractGantt','HierarchicalBudget','HierarchicalSkill','PlanningWorkPlan'];
  ...
  if (idProject != "") {
    var callBack=function() {
      ...
      if (dojo.byId("GanttChartDIV")) {
        ...
        }else if (dojo.byId("workPlanJsonData") && dojo.byId("planningJsonData")) {
          refreshJsonPlanning();
        } else {
          loadContent("planningList.php","listDiv",'listForm');
        }
      } else if (dojo.byId("workPlanGanttChartDIV")) {
